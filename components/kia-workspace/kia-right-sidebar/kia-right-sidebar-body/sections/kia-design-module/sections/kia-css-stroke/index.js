...
class KIA_CSS_Stroke extends KIACustomElement {

    methods = methods;
    props = props;
    customizer = {styleHref: `/components/kia-workspace/kia-right-sidebar/kia-right-sidebar-body/sections/kia-design-module/sections/kia-css-stroke/style.css?v=${cacheVersion}`};
...
if (!customElements.get('kia-css-stroke')) {
    customElements.define('kia-css-stroke', KIA_CSS_Stroke);
}