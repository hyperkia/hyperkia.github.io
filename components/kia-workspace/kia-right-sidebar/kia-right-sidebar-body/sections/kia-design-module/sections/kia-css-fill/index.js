...
class KIA_CSS_Fill extends KIACustomElement {

    methods = methods;
    props = props;
    customizer = {styleHref: `/components/kia-workspace/kia-right-sidebar/kia-right-sidebar-body/sections/kia-design-module/sections/kia-css-fill/style.css?v=${cacheVersion}`};
...
if (!customElements.get('kia-css-fill')) {
    customElements.define('kia-css-fill', KIA_CSS_Fill);
}