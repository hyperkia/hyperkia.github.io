...
class KIA_CSS_Tag extends KIACustomElement {

    methods = methods;
    props = props;
    customizer = {styleHref: `/components/kia-workspace/kia-right-sidebar/kia-right-sidebar-body/sections/kia-design-module/sections/kia-css-tag/style.css?v=${cacheVersion}`};
...
if (!customElements.get('kia-css-tag')) {
    customElements.define('kia-css-tag', KIA_CSS_Tag);
}