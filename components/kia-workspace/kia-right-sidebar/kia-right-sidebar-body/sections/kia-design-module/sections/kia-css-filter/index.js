...
class KIA_CSS_Filter extends KIACustomElement {

    methods = methods;
    props = props;
    customizer = {styleHref: `/components/kia-workspace/kia-right-sidebar/kia-right-sidebar-body/sections/kia-design-module/sections/kia-css-filter/style.css?v=${cacheVersion}`};
...
if (!customElements.get('kia-css-filter')) {
    customElements.define('kia-css-filter', KIA_CSS_Filter);
}