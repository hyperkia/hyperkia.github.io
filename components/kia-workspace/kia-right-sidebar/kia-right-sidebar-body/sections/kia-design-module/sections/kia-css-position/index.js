...
class KIA_CSS_Position extends KIACustomElement {
    ...
    customizer = {styleHref: `/components/kia-workspace/kia-right-sidebar/kia-right-sidebar-body/sections/kia-design-module/sections/kia-css-position/style.css?v=${cacheVersion}`};
    methods = methods;
    props = props;
