...
class KIA_CSS_Effect extends KIACustomElement {
    ...
    methods = methods;
    props = props;
    customizer = {styleHref: `/components/kia-workspace/kia-right-sidebar/kia-right-sidebar-body/sections/kia-design-module/sections/kia-css-effect/style.css?v=${cacheVersion}`};
