...
class KIA_Assets_Manager_Modal extends KIACustomElement {

    methods = methods;
    props = props;
    customizer = {styleHref: `/components/kia-overlays/kia-modals/modals/kia-assets-manager-modal/style.css?v=${cacheVersion}`};
...
if (!customElements.get('kia-assets-manager-modal')) {
    customElements.define('kia-assets-manager-modal', KIA_Assets_Manager_Modal);
}